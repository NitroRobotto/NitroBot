...
const starterList = [edgeStarters, mulletStarters, happyStarters, sombreroStarters, happyKamoticon];
const phraseList = [edgePhrases, mulletPhrases, happyPhrases, sombreroPhrases, happyKamoticon];

module.exports = {
	data: new SlashCommandBuilder()
		.setName('phrase')
		.setDescription('Combines two random phrases! Unlimited fun!')
		.addIntegerOption(option =>
			option.setName('starter').setDescription('Select a starter action.')
				.setRequired(true)
				.addChoices(
					{ name: 'Edge', value: 0 },
					{ name: 'Mullet', value: 1 },
					{ name: 'Happy', value: 2 },
					{ name: 'Sombrero', value: 3 },
					{ name: 'Kamotikon', value: 4 },
				))
		.addIntegerOption(option =>
			option.setName('phrase').setDescription('Select a phrase type.')
				.setRequired(true)
				.addChoices(
					{ name: 'Edge', value: 0 },
					{ name: 'Mullet', value: 1 },
	...
	async execute(interaction) {
		const starter = interaction.options.getInteger('starter', true);
		const phrase = interaction.options.getInteger('phrase', true);

		await interaction.reply(`${GetRandomFromList(starterList[starter])} *** ${GetRandomFromList(phraseList[phrase])} ***`);
	},
};